    ...
    <>
      <main className="container mx-auto content-center">
        ...
        <div className="flex justify-center">
          <div className="flex flex-col items-center rounded-lg border border-gray-200 bg-white shadow md:max-w-2xl md:flex-row">
            <img
              className="h-96 w-full rounded-t-lg object-cover md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
              src="public\img\pexels-polina-kovaleva-5644688.jpg"
              alt=""
            />
